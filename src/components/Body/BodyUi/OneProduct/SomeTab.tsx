...
import SomeInfoDelivery from "./SomeInfoDelivery";
...
const extractTextFromDescription = (description: any): string => {
  if (typeof description === 'string') {
    ...
    return description.map((child: any) => extractTextFromDescription(child)).join('\n');
  } else if (description?.text) {
    return description.text;
  } else if (description?.children) {
    return description.children.map((child: any) => extractTextFromDescription(child)).join('\n');
  }
  return '';
};
